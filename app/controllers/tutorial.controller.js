...
const Productiondatabase = db.Productiondatabase;
const Tutorial = Productiondatabase;
...
exports.findOne = (req, res) => {
  ...
  exports.findOne = (req, res) => {
    Tutorial.findOne({ where: { hotel_id: req.params.hotel_id, user_id:req.params.user_id} })
      .then(data => {
        if (data) {
          res.send(data);
        } else {
